...
class DayScheduleWhereInput {
  ...
  @ApiProperty({
    required: false,
    type: () => ScheduleIntervalListRelationFilter,
  })
  @ValidateNested()
  @Type(() => ScheduleIntervalListRelationFilter)
  @IsOptional()
  @Field(() => ScheduleIntervalListRelationFilter, {
    nullable: true,
  })
...
export { DayScheduleWhereInput as DayScheduleWhereInput };

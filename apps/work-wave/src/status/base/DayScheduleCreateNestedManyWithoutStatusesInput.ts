...
@InputType()
class DayScheduleCreateNestedManyWithoutStatusesInput {
...
export { DayScheduleCreateNestedManyWithoutStatusesInput as DayScheduleCreateNestedManyWithoutStatusesInput };
